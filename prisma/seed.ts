...
async function seed() {
  ...
  const kodyImages = await promiseHash({
    ...
    cuteKoala: img({
      ...
      filepath: "./tests/fixtures/images/kody-tech/cute-koala.png",
    }),
    koalaEating: img({
      altText: "a cartoon illustration of a koala in a tree eating",
      filepath: "./tests/fixtures/images/kody-tech/koala-eating.png",
    }),
    koalaCuddle: img({
      altText: "a cartoon illustration of koalas cuddling",
      filepath: "./tests/fixtures/images/kody-tech/koala-cuddle.png",
    }),
    mountain: img({
      altText: "a beautiful mountain covered in snow",
      filepath: "./tests/fixtures/images/kody-tech/mountain.png",
    }),
    koalaCoder: img({
      altText: "a koala coding at the computer",
      filepath: "./tests/fixtures/images/kody-tech/koala-coder.png",
    }),
    koalaMentor: img({
      altText:
        "a koala in a friendly and helpful posture. The Koala is standing next to and teaching a woman who is coding on a computer and shows positive signs of learning and understanding what is being explained.",
      filepath: "./tests/fixtures/images/kody-tech/koala-mentor.png",
    }),
    koalaSoccer: img({
      altText: "a cute cartoon koala kicking a soccer ball on a soccer field ",
      filepath: "./tests/fixtures/images/kody-tech/koala-soccer.png",
    }),
  });
